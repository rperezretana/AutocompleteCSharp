...
It has to be preloaded first with the list of terms, this preloading intentds to happen when the application loads, is set up in the global asax, after it is preloaded it can be updated with new terms.
